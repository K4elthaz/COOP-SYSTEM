                ...
                <div class="card" id="form" position="aboslute">
                    ...
                    <div class="row card-body">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="memberName" id="name" value=" <?php echo $name ?>" style="font-weight: bold;" disabled>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" class="form-control" name="tin" id="tin" value="<?php echo $tin ?>" style="font-weight: bold;" disabled>

                        </div>
                        <!-- Enter Contact Number -->
                        <div class="col-sm-6">
                            <label for="ContactNumber" class="form-label">Contact Number</label>
                            <input type="number" class="form-control" name="contactNumber" id="contactNumber" value="<?php echo $contactNumber ?>" style="font-weight: bold;" disabled>
                        </div>
                        <!-- Enter Birthdate -->
                        <div class="col-sm-6">
                            <label for="birthDate" class="form-label">Birth Date</label>
                            <input type="date" class="form-control" name="birthDate" id="birthDate" value="<?php echo $birthday ?>" style="font-weight: bold;" disabled>
                        </div>
                        <!-- Enter Address -->
                        <div class="col-sm-6">
